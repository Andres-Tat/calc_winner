...
ДАННЫЕ ДЛЯ ЗАДАЧИ:
    ...
    Первый день: "crazyKats"- 44, 23, 71  "funnyDucks" 65, 54, 49
    Второй день: "crazyKats"- 85, 54, 41  "funnyDucks" 23, 34, 27
...
const calcAverage = (res1, res2, res3) => (res1 + res2 + res3) / 3    //стрелочная функция

let crazyKats = calcAverage(44, 23, 71)     //создал функцию по выведению среднего значения для команды Kats
let funnyDucks = calcAverage(65, 54, 49)    //создал функцию по выведению среднего значения для команды Ducks




function checkWinner(avgKats, avgDucks) {                      // создал вариацию условий, которые помогут определить победителя, с помошью if/ else if и вывести результат в консоль
    if (avgKats >= 2 * avgDucks) {
        console.log(`crazyKats победили с результатом ${avgKats} против funnyDuck c результатом ${avgDucks}`)
...
//Второй день    подставил значения для Второго дня

crazyKats = calcAverage(84, 54, 41)
